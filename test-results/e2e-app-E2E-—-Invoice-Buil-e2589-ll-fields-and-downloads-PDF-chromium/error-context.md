...
- Name: e2e-app.spec.ts >> E2E — Invoice Builder >> creates invoice, fills all fields, and downloads PDF
- Location: tests/e2e-app.spec.ts:11:7
...
Call log:
  - waiting for locator('input[placeholder="Company name"]') to be visible
