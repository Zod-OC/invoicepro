...
**Title:** Billify — Free PDF invoice generator, no signup required

**Tagline:** Generate professional invoices in seconds. Privacy-first. Browser-only. No strings attached.

---

## Description

Invoicing is still way too complicated for freelancers and small businesses. Most tools force you to create an account, link a bank card, or drown in features you'll never use.
...
I'm the maker behind Billify. A few months ago I was helping a freelancer friend set up invoicing and was shocked by how every tool demanded an account, an email, and a credit card just to generate a simple PDF. For someone sending 5–10 invoices a month, that's overkill.

So I built Billify as the tool I wish existed:
- Open the site → build your invoice → download a PDF → done.
...
**Upvote if you think invoicing should be this simple.** 🙏
