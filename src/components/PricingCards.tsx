...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: ['Unlimited invoices', '10 premium templates', 'Custom branding colors', 'Invoice history & search', 'Export CSV/Excel', 'No watermark'],
    planKey: 'pro',
  ...
  },
  {
    ...
    features: ['Everything in Pro', '10 premium templates', 'Up to 5 team members', 'Shared templates', 'Admin dashboard', 'API access (soon)', 'Priority support'],
    planKey: 'team',
